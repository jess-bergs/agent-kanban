      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="flex items-center gap-3 mt-1.5 flex-wrap">
            <span className="inline-flex items-center gap-1.5 text-xs text-tertiary bg-surface-700 px-2.5 py-1 rounded-md border border-surface-600 font-mono">
            ...
            {project.remoteUrl && (
              <span className="inline-flex items-center gap-1.5 text-xs text-tertiary bg-surface-700 px-2.5 py-1 rounded-md border border-surface-600">
